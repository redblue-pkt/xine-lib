...
static const hcb *hcb_table[];
static const hcb_2_quad *hcb_2_quad_table[];
static const hcb_2_pair *hcb_2_pair_table[];
static const hcb_bin_pair *hcb_bin_table[];
static const uint8_t hcbN[];
static const uint8_t unsigned_cb[];
static const int hcb_2_quad_table_size[];
static const int hcb_2_pair_table_size[];
static const int hcb_bin_table_size[];
