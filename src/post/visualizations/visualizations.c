...
static const post_info_t tdaan_special_info = { XINE_POST_TYPE_AUDIO_VISUALIZATION };
...
const plugin_info_t xine_plugin_info[] EXPORTED = {
  ...
  { PLUGIN_POST, 10, "tdaudioanalyzer", XINE_VERSION_CODE, &tdaan_special_info, &tdaan_init_plugin },
