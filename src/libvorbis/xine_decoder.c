 ...
 *
 * $Id: xine_decoder.c,v 1.36 2003/12/09 00:02:34 f1rmb Exp $
 *
...
static void get_metadata (vorbis_decoder_t *this) {
  ...
  _x_meta_info_set(this->stream, XINE_META_INFO_AUDIOCODEC, "vorbis");
}
...
plugin_info_t xine_plugin_info[] = {
  ...
  { PLUGIN_AUDIO_DECODER, 13, "vorbis", XINE_VERSION_CODE, &dec_info_audio, init_plugin },
