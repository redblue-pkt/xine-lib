...
/* $Id: executor.c,v 1.1 2002/07/14 23:33:35 miguelfreitas Exp $ */
#include <fftw-int.h>
#include <stdio.h>
#include <stdlib.h>

const char *fftw_version = "FFTW V" FFTW_VERSION " ($Id: executor.c,v 1.1 2002/07/14 23:33:35 miguelfreitas Exp $)";
